...
| Twitch application          | Owner action required                | IGDB requires Twitch application credentials; Twitch requires a verified account, 2FA, and a unique application name.                                                                                                        | Before the first live M1 smoke test, register the application under the working name and store its credentials outside Git. |
